...
This is a dataset about Divisions, Districts and Sub Districts in Bangladesh in SQL format

## Tables

The code below creates respective three tables and inserts location data to them.
...
INSERT INTO `sub_districts` (`id`, `district_id`, `name`, `bn_name`, `url`) VALUES
...
Please give a star to [This Repo (GitHub)](https://github.com/nuhil/bangladesh-geocode).
If you need this data on another format. Please visit the repo. 

Currently available with CSV, JSON, PHP, SQL & XML
